...
//printf("args are %d and %f\n", PDH_acnt, PDH_res);
	...
	int blockcount = 256;
	PDH_kernel2<<<ceil(PDH_acnt/(256.0)), blockcount, 3*blockcount*sizeof(double)>>>(d_gpu_histogram, d_atom_x_list, d_atom_y_list, d_atom_z_list, PDH_acnt, PDH_res, blockcount);
